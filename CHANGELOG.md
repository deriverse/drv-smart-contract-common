...
## Added
- self documented `RULES` fro `InputInstrMask`

## [v2.75] - 2026-09-09

## Changed
- `MIN_ACCOUNTS` in finalise_deactivate to `4`

## Added 
- `Forex` Flag to `ALLOW_LIST` for `InstrMask`

## [v2.74]

## Added
- `MIN_EMA_CHANGE_FACTOR` for ema px optimization

## [v2.73]

## Added
- `spot_quotes_replace_v2` instruction

## [v2.72]

## Added 
- `LastUpdate` type for `ObligationPrefix`

## [v2.71]

## Changed
- Removed `fees_deposit` and `fees_withdraw` related models
- Removed `PrivateClientsAccount`, remove whitelist feature from `private_mode`

## [v2.70]

## Changed
- Added `crncy_mint` account to `new_instrument` instruction

## [v2.69]

## Changed
- `MIN_FEE_RATE`, `START_SPOT_FEE_RATE`, `START_PERP_FEE_RATE` to 4
