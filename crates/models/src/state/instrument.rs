...
pub struct InstrAccountHeader {
    ...
    pub alltime_asset_tokens: CappedI64,
    pub alltime_crncy_tokens: CappedI64,
    pub day_trades: u32,
    pub lp_day_trades: u32,
    pub lp_alltime_fees: CappedI64,
    ...
    pub perp_alltime_asset_tokens: CappedI64,
    pub perp_alltime_crncy_tokens: CappedI64,
